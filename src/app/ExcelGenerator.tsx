...
export default function ExcelGenerator() {
  ...
  const handleGenerateExcel = () => {
    ...
    const parameters = [
      ...
      { name: "Code A [PRO]", length: 2 * 32, type: "hex" },
      { name: "Code B [PRO]", length: 2 * 32, type: "hex" },
      { name: "Code [Fixed]", length: 2 * 32, type: "hex" },
      ...
      { name: "Consensus Average Count [Fixed]", length: 2 * 4, type: "int" },
      {
